...
namespace WFCalendarApp {
    ...
    class ChartWriter {
        ...
        public Chart WriteChart(Dictionary<Employee, List<TimePeriod>> data, DateTime start, DateTime end) {
            ...
            list = data.OrderByDescending(pair => pair.Key.Name).ToList();
        ...
        //who tf thought it was a good idea to make x go up and down and y go left to right..............................
        ...
        private void FormatYAxis(DateTime start, DateTime end) {
            ...
            yAxis.MinorTickMark.Interval = .25;
        ...
        private string MakeToolTip(Employee employee, TimePeriod t) {
            ...
            result += Environment.NewLine + "Description: " + t.summary;
            return result;
        }
    }
}
